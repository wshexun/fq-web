...
<div class="back_bg">
    <table border="0" style="width:92%; color:#FFF; margin:0 auto;" cellspacing="0" cellpadding="0">
        <tr>
            <td style="text-align:left; font-size:1.2em;">支付开通失败</td>
        </tr>
    </table>
</div>
<!--End Header End-->
    ...
    <form>
        <div class="log_tab">
            <div class="log_c">
                ...
                <div style="text-align: center;font-size: 1.6em;font-weight: bolder">支付开通失败！</div>
            </div>
            <div class="log_c">
                <table border="0" style="width:100%; font-size:1.4em;" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="100" style="text-indent:8px;">失败原因：</td>
                        <td><input type="text" value="卡片已超过有效期,请使用其它卡片支付!" placeholder="" class="l_ipt"></td>
                    </tr>
                </table>
            </div>
        </div>
        <table border="0" style="width:91%; margin:5% auto 0 auto;" cellspacing="0" cellpadding="0">
            <tr height="60">
                <td><input type="submit" value="重新填写信息支付" readonly class="l_btn"></td>
            </tr>
        </table>
    </form>
</div>
